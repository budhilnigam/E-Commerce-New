...
if (!cart) {
    ...
    <svg aria-hidden="true" class="w-16 h-16 text-transparent animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none">
...
Deliver at {userDetails.line1}<br/>
                    ...
                    {<AddressForm type="Change address" line1={line1} line2={line2} city={city} state={state} pincode={pincode} setLine1={setLine1} setLine2={setLine2} setCity={setCity} setState={setState} setPincode={setPincode} setPrimary={setPrimary} address_changed={address_changed} setAddress_changed={setAddress_changed}/>}</div>
